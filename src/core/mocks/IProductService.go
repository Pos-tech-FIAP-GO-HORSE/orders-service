...
func (_m *IProductService) DeleteByID(ctx context.Context, id string) (*entity.Product, error) {
...
func (_m *IProductService) FindByPublicID(ctx context.Context, publicID string) (*entity.Product, error) {
